...
export class AutorisationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(!this.clientEstCompatible()) {
      ...
      this.autorisation.autorisation = true;
    }
  }


  public clientEstCompatible() {
    let osOk = false;
    ...
    if (this.jscd.browser === "Chrome") {
      if (this.jscd.browserMajorVersion >= 80) {
        navigateurOk = true;
      }
    } else if (this.jscd.browser === "Safari") {
      if (this.jscd.browserMajorVersion >= 13) {
        navigateurOk = true;
      }
    } else if (this.jscd.browser === "Firefox") {
      if (this.jscd.browserMajorVersion >= 52) {
        navigateurOk = true;
      }
    }
    return osOk && navigateurOk;
  }

  private recuperationDesVersionUtilisateur() {
    /**
